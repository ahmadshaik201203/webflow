...
const ContactForm = () => {
  ...
  const onSubmit = async (data) => {
    if (!recaptchaValue && import.meta.env.VITE_RECAPTCHA_SITE_KEY) {
    ...
    <div className="flex-center">
      ...
      >
        ...
        {import.meta.env.VITE_RECAPTCHA_SITE_KEY ? (
          ...
          // No ReCAPTCHA key set — bypass verification in dev
          <p className="text-xs text-[#a7a7a7] text-center">
            (ReCAPTCHA disabled — add <code>VITE_RECAPTCHA_SITE_KEY</code> to .env to enable)
          </p>
        )}
