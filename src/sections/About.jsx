              ...
              <div className="bg-black-300 rounded-2xl p-7 w-full h-full">
                ...
                <div className="mt-5">
                  ...
                  <p className="md:text-2xl mt-2">
                    I am an India-based Frontend Web Developer, primarily
                    ...
                    CSS, JavaScript, and diving into React JS. My goal is
                    always to build user-friendly and visually appealing
                    websites.
                  </p>
                </div>
              </div>
